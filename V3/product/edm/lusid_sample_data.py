...
def authenticate_secrets():
    ...
    class LusidApi():
        ...
        def __init__(self, client):
            self.aggregation = lu.AggregationApi(client)
            self.metadata = lu.ApplicationMetadataApi(client)
            self.corporate_action_sources = lu.CorporateActionSourcesApi(client)
            self.data_types = lu.DataTypesApi(client)
            self.derived_transaction_portfolios = lu.DerivedTransactionPortfoliosApi(client)
            self.instruments = lu.InstrumentsApi(client)
            self.login = lu.InstrumentsApi(client)
            self.portfolio_groups = lu.PortfolioGroupsApi(client)
            self.portfolios = lu.PortfoliosApi(client)
            self.property_definitions = lu.PropertyDefinitionsApi(client)
            self.quotes = lu.QuotesApi(client)
            self.reconciliations = lu.ReconciliationsApi(client)
            self.reference_portfolios = lu.ReferencePortfolioApi(client)
            self.results = lu.ResultsApi(client)
            self.schemas = lu.SchemasApi(client)
            self.scopes = lu.ScopesApi(client)
            self.search = lu.SearchApi(client)
            self.transaction_portfolios = lu.TransactionPortfoliosApi(client)
            self.cut_labels = lu.CutLabelDefinitionsApi(client)
    ...
    api_factory = SyncApiClientFactory(access_token=RefreshingToken(), secrets_path=secrets_path, app_name="LusidJupyterNotebook")
